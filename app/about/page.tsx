...
export default function Page() {
  return (
    <>
      ...
      <ul className="anim text-center font-sans leading-loose px-5">
        <li className="mb-24">
          <div className="text-xl sm:text-2xl">A true story</div>
          <div className="flex justify-center text-sm sm:text-base mt-2 font-light">
            Being translated and archived with care.
          </div>
        </li>
        <li className="mb-24">
          <div className="text-xl sm:text-2xl">Anywhere you are</div>
          <div className="flex justify-center text-sm sm:text-base mt-2 font-light">
        ...
        <li className="mb-24">
          ...
          <div className="flex justify-center text-sm sm:text-base mt-2 font-light">
            ...
            <img
              src="/svg/bookmark_saved.svg"
              width="16"
              height="24"
              alt="bookmark saved icon"
            />
            <div className="ml-3">means the post is bookmarked.</div>
          </div>
        </li>
        <li className="mb-24">
          <div className="text-xl sm:text-2xl">Your place in time</div>
          <div className="text-sm sm:text-base mt-2 font-light">
            While on a post the proceeding timeline <br />
            will begin with the next chronological post date.
          </div>
        </li>
        <li className="mb-24">
          <div className="text-xl sm:text-2xl">The latest translations</div>
          <div className="flex justify-center text-sm sm:text-base mt-2 font-light">
        ...
        <li className="mb-24">
          <div className="text-xl sm:text-2xl">Made with Love</div>
          <div className="text-sm sm:text-base mt-2 font-light">
